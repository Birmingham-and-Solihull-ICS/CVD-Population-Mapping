...
for (LA_filter in LA_filters) {
    ...
    write_xlsx(data_i, paste("../../output/Clinical_Groupings/Primary_Cause/Hospitalisations/Tables/PrimaryCause_Hospitalisations_", area, ".xlsx", sep = ""))
    ...
    ggsave(paste("../../output/Clinical_Groupings/Primary_Cause/Hospitalisations/PrimaryCause_Hospitalisations_", area, ".png", sep = ""), plot_i, width = 9, height= 12)
...
for(characteristic in characteristics) {
  ...
  max_value <- data_i %>%
    ...
    write_xlsx(data_i, paste("../../output/Clinical_Groupings/Primary_Cause/Hospitalisations/Tables/PrimaryCause_Hospitalisations_BSol_by_", characteristic, ".xlsx", sep = ""))
    ...
    ggsave(paste("../../output/Clinical_Groupings/Primary_Cause/Hospitalisations/PrimaryCause_Hospitalisations_BSol_by_", characteristic, ".png", sep = ""), plot_i, width = 10, height= 12)
    }
...
PercentageDeaths <- read_excel("../../output/Clinical_Groupings/Primary_Cause/Deaths/Tables/PrimaryCause_PercentageDeaths_ClinicalSubgroup_BSol.xlsx")
...
# save output
write_xlsx(df_long, "../../output/Clinical_Groupings/Primary_Cause/PrimaryCause_PercentageHospitalisationsAndDeaths_BSol.xlsx")
...
ggsave("../../output/Clinical_Groupings/Primary_Cause/PrimaryCause_Hospitalisations_vs_Deaths_BSol.png", HospVsDeaths, width = 10, height= 12)

## plot as stacked bar

stackedHospVsDeaths <- ggplot(df_long, aes(x = Outcome, y = Percentage, fill = `Clinical Subgroup`)) +
  geom_bar(position = "stack", stat = "identity") +
  labs(title = "Percentage of Hospitalisations (2018 to 2024) and Deaths (2014 to 2023), Primary Cause, BSol",
       y = "Percentage of Total",
       fill = "Clinical Subgroup") +
  theme_bw() +
  scale_y_continuous(
...
ggsave("../../output/Clinical_Groupings/Primary_Cause/PrimaryCause_stacked_Hospitalisations_vs_Deaths_BSol.png", stackedHospVsDeaths, width = 8, height= 10)

#### Yearly number of deaths vs yearly number of hospitalizations scatter plot #####################################

# load data
YearlyHospitalisations <- read_excel("../../output/Clinical_Groupings/Primary_Cause/Hospitalisations/Tables/PrimaryCause_Hospitalisations_BSol.xlsx")
YearlyDeaths <- read_excel("../../output/Clinical_Groupings/Primary_Cause/Deaths/Tables/PrimaryCause_DeathsYLL_BSol.xlsx")
...
htmlwidgets::saveWidget(plot, file="../../output/Clinical_Groupings/Primary_Cause/PrimaryCause_Hospitalisations_vs_Deaths_Scatter.html")
